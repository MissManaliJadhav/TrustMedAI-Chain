...
def _adversarial_rows(record: DiagnosisRecord) -> list[tuple[str, Any]]:
    ...
    return [
        ...
        ("AECS", _percent(aecs_details.get("percentage") or aecs_details.get("score")) if aecs_details.get("available") else "Not Available"),
        ("AECS Method", aecs_details.get("method")),
        ("AECS Original Explanation", aecs_details.get("original_explanation")),
        ("AECS Adversarial Explanation", aecs_details.get("adversarial_explanation")),
        ("AECS Similarity", _percent(aecs_details.get("percentage") or aecs_details.get("similarity")) if aecs_details.get("available") else "Not Available"),
        ("AECS Distance", aecs_details.get("explanation_distance") or aecs_details.get("distance")),
        ("AECS Status", aecs_details.get("status")),
        ("AECS Reason", aecs_details.get("reason")),
        ("AECS Attack Evaluated", aecs_details.get("attack_evaluated")),
